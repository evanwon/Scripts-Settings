echo off
:: Windows7 VHD (Developer)
:: Guid = {b858299f-fe90-11de-b31b-be9a647009c0}
...
bcdedit /set {b858299f-fe90-11de-b31b-be9a647009c0} osdevice vhd="[v:]\native\developer\ultimatex64_development.vhd"
bcdedit /set {b858299f-fe90-11de-b31b-be9a647009c0} device vhd="[v:]\native\developer\ultimatex64_development.vhd"
